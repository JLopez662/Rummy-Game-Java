...
public interface CardInterface extends Comparable<Object> {
  ...
  /**
   * Creates a new playing card initializing the ImageIcon
   * @param suit the suit value of this card.
   * @param rank the rank value of this card
   */
...
//	public static int getRankIndex(char rank);
	  ...
	  /**
   * Returns a String by the name of the directory named above
   * concatenated with the toString method of Card and ".gif"
   */
   ...
   */
   ...
   /**
    * Function that checks if a certain card exists within a list 
    * of cards or not.
    * @param card
    */
